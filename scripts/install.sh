...
ExecStart=$CURRENT_DIR/venv/bin/python -m assistive_vision
Restart=always
RestartSec=10
...
main() {
    ...
    echo "2. Test �al��t�r�n: PYTHONPATH=\$PWD/src python tests/test_windows.py"
    echo "3. Sistemi ba�lat�n: PYTHONPATH=\$PWD/src python -m assistive_vision"
    echo
